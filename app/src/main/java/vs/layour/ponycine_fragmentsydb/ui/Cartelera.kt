...
import vs.layour.ponycine_fragmentsydb.Adapter.CarteleraAdapter
import vs.layour.ponycine_fragmentsydb.R
import vs.layour.ponycine_fragmentsydb.databinding.CarteleraFragmentBinding
import vs.layour.ponycine_fragmentsydb.models.ListHorario
import vs.layour.ponycine_fragmentsydb.models.ListPelicula
...
class Cartelera : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      super.onViewCreated(view, savedInstanceState)
        ...
        horariopelicula.add(ListHorario("12:00","15 Jun 2021"))
        horariopelicula.add(ListHorario("13:00","15 Jun 2021"))
        horariopelicula.add(ListHorario("14:00","15 Jun 2021"))
        horariopelicula.add(ListHorario("15:00","16 Jun 2021"))
        horariopelicula.add(ListHorario("16:00","16 Jun 2021"))
        horariopelicula.add(ListHorario("17:00","16 Jun 2021"))
        horariopelicula.add(ListHorario("18:00","15 Jun 2021"))
        ...
        listpelis.add(ListPelicula("Fragmentado.", "A",R.drawable.fragmentado,"Descripcion", horariopelicula))
